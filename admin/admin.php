			...
			<?php		
					...
					switch($_GET['do']){
						...
						case 'modif_utilisateur':{
							include("Controleur/ctrl_modif_utilisateur.php");
							break;
						}
						case 'sup_utilisateur':{
							include("Controleur/ctrl_sup_utilisateur.php");
							break;
						}
						case 'modif_recette':{
							include("Controleur/ctrl_modif_recette.php");
							break;
						}
						case 'sup_recette':{
							include("Controleur/ctrl_sup_recette.php");
							break;
						}
						case 'modif_ingredient':{
							include("Controleur/ctrl_modif_ingredient.php");
							break;
						}
						case 'sup_ingredient':{
							include("Controleur/ctrl_sup_ingredient.php");
							break;
						}
						case 'deconnexion':{
